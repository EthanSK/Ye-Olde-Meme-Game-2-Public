...
Once you've verified your modded level works in "Play Created Level" mode, you'll want to publish it. A level with mods has some slight differences with regards to how it's treated in the eyes of the end-user of your level.
...
There is an option to filter out levels that have mods in them on the "Browse Published Levels" page. This filter is off by default. Think about that.
