...
3. Exit the level options panel, and find and click on Memeorang Man. Then click the blue script button:
...
7. Paste the example into the editor, and add the line `memeorangManRigidbody2D.gravityScale = 0.069` at the end to change the gravity:
